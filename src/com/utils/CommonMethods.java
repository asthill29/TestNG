...
public class CommonMethods {
	...
	public static void switchToFrame(int index) {
		...
		try {
		 ...
		 /** This methods will  click using JSExecutor
	    ...
	    /**
	     * This method will scroll until specified element using JSExecutor
	     * @param element WebElement
	     */
	    public static void jsScrollIntoElement(WebElement element) {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("arguments[0].scrollIntoView(true);", element);
	    }
	    /**
	     * This method will scroll page down using JSExecutor
	     * @param pixel
	     */
	    ...
	    /**
	     * This method will scroll page up using JSExecutor
	     * @param pixel
	     */
	    public static void jsScrollUp(int pixel) {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0-,"+ pixel + ")");
	    }
	        ...
	        public static void takescreenshot(String fileName) {
	            ...
	            TakesScreenshot ts=(TakesScreenshot)driver;
	     		...
	     		try {
	     			...
	     			System.out.println("Cannot take screeshot");
	     		}
